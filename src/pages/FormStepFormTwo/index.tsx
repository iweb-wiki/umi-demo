...
interface FormStepFormTwoProps {
...
const FormStepFormTwo: React.FC<FormStepFormTwoProps> = ({ current }) => {
...
export default connect(
  ({ formStepFormTwo }: { formStepFormTwo: StateType }) => ({
    current: formStepFormTwo.current,
  }),
)(FormStepFormTwo);
